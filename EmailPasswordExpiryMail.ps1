...
{ 
    ...
    # Subject Setting 
    $subject="Service informatique - Votre mot de passe expirera $messageDays" 
...
### Mail to Sysadmin 
$messageSysAdmin = New-Object System.Net.Mail.MailMessage $smtpfromSysadmin, $smtptoSysadmin
...
$messageSysAdmin.Body = $notifiedUsers | select UserName,Name,EmailAddress,PasswordSet,DaysToExpire,ExpiresOn | sort DaystoExpire | ConvertTo-Html -Head $style 
